...
func (o *CertificateDto) GetGroup() GroupDto {
...
// and a boolean to check if the value has been set.
func (o *CertificateDto) GetGroupOk() (*GroupDto, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *CertificateDto) HasGroup() bool {
	if o != nil && !IsNil(o.Group) {
		return true
	}
...
func (o *CertificateDto) SetGroup(v GroupDto) {
	o.Group = &v
}

...
func NewUserDetailDto(uuid string, username string, enabled bool, systemUser bool, roles []RoleDto) *UserDetailDto {
	this := UserDetailDto{}
	this.Uuid = uuid
...
func (o *UserDetailDto) GetGroupName() string {
...
// and a boolean to check if the value has been set.
func (o *UserDetailDto) GetGroupNameOk() (*string, bool) {
	if o == nil || IsNil(o.GroupName) {
		return nil, false
	}
...
func (o *UserDetailDto) HasGroupName() bool {
	if o != nil && !IsNil(o.GroupName) {
		return true
	}
...
func (o *UserDetailDto) SetGroupName(v string) {
	o.GroupName = &v
}

// GetGroupUuid returns the GroupUuid field value if set, zero value otherwise.
func (o *UserDetailDto) GetGroupUuid() string {
...
// and a boolean to check if the value has been set.
func (o *UserDetailDto) GetGroupUuidOk() (*string, bool) {
	if o == nil || IsNil(o.GroupUuid) {
		return nil, false
	}
...
func (o *UserDetailDto) HasGroupUuid() bool {
	if o != nil && !IsNil(o.GroupUuid) {
		return true
	}
...
func (o *UserDetailDto) SetGroupUuid(v string) {
	o.GroupUuid = &v
}

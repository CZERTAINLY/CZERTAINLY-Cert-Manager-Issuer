...
type MetadataResponseDto struct {
	...
	ConnectorUuid string `json:"connectorUuid"`
...
func NewMetadataResponseDto(connectorUuid string, connectorName string, items []ResponseMetadataDto) *MetadataResponseDto {
...
// GetConnectorUuid returns the ConnectorUuid field value
...
// GetConnectorUuidOk returns a tuple with the ConnectorUuid field value
...
// SetConnectorUuid sets field value

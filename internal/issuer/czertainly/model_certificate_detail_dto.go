...
func (o *CertificateDetailDto) GetGroup() GroupDto {
...
// and a boolean to check if the value has been set.
func (o *CertificateDetailDto) GetGroupOk() (*GroupDto, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *CertificateDetailDto) HasGroup() bool {
	if o != nil && !IsNil(o.Group) {
		return true
	}
...
func (o *CertificateDetailDto) SetGroup(v GroupDto) {
	o.Group = &v
}

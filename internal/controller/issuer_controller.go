...
//+kubebuilder:rbac:groups=czertainly-issuer.czertainly.com,resources=issuers,verbs=get;list;watch
//+kubebuilder:rbac:groups=czertainly-issuer.czertainly.com,resources=issuers/status,verbs=get;update;patch
...
func (r *IssuerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&czertainlyissuerv1alpha1.Issuer{}).
		Complete(r)
}

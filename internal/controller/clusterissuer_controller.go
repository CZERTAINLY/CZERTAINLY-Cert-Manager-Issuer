...
//+kubebuilder:rbac:groups=czertainly-issuer.czertainly.com,resources=clusterissuers,verbs=get;list;watch
//+kubebuilder:rbac:groups=czertainly-issuer.czertainly.com,resources=clusterissuers/status,verbs=get;update;patch
...
func (r *ClusterIssuerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&czertainlyissuerv1alpha1.ClusterIssuer{}).
		Complete(r)
}

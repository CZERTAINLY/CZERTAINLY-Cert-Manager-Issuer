...
type ResponseMetadataDto struct {
	...
	// Source Objects
	SourceObjects []NameAndUuidDto `json:"sourceObjects"`
...
func NewResponseMetadataDto(name string, label string, type_ AttributeType, contentType AttributeContentType, sourceObjects []NameAndUuidDto) *ResponseMetadataDto {
...
// GetSourceObjects returns the SourceObjects field value
...
// GetSourceObjectsOk returns a tuple with the SourceObjects field value
// and a boolean to check if the value has been set.
...
// SetSourceObjects sets field value
